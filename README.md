...
2. Download one of the available Ubuntu 14.04lts images from www.odroid.in:

  - Server(no GUI) link: http://www.odroid.in/ubuntu_14.04lts/ubuntu-14.04lts-server-odroid-xu3-20140902.img.xz
  - Server MD5 Hash link: http://www.odroid.in/ubuntu_14.04lts/ubuntu-14.04lts-server-odroid-xu3-20140902.img.xz.md5sum
...
2. Once you have downloaded the .img file we will need to extract it using 7zip, and then burn the image to our SD card using WinDisk imager on Windows, or `dd` on linux.
...
7. Next lets download, unzip, and choose eth-install.sh OR geth-install.sh:
	...
	`wget https://github.com/EthEmbedded/OdroidXU3-Eth-Install/archive/v0.1.7.tar.gz`
